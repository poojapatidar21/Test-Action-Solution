...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const PackageLocation = core.getInput('PackageLocation');
            console.log(PackageLocation);
            const Owners = core.getInput('Owners');
            console.log(Owners);
            const Approvers = core.getInput('Approvers');
            console.log(Approvers);
            const ServiceEndpointUrl = core.getInput('ServiceEndpointUrl');
            console.log(ServiceEndpointUrl);
            const MainPublisher = core.getInput('MainPublisher');
            console.log(MainPublisher);
            const DomainTenantId = core.getInput('DomainTenantId');
            console.log(DomainTenantId);
            const ContentOrigin = core.getInput('ContentOrigin');
            console.log(ContentOrigin);
            const ProductState = core.getInput('ProductState');
